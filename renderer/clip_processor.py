...
from utils.energy_ramp import apply_energy_ramp
from exceptions import FileError, AudioProcessingError, DSPError
from dsp.fade_curves import FadeCurve
from dsp.sfx_processor import apply_sfx_processing, get_sfx_fade_behavior
from dsp.balance import apply_role_loudness
from dsp.eq import apply_eq_preset, get_preset_for_role
...
class ClipProcessor:
    ...
    def __init__(
        ...
        if self.fade_in_func is None:
            from dsp.fades import apply_fade_in
